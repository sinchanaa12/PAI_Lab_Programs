...
responses = {
    ...
    "tell me a joke": ["Why don't scientists trust atoms? Because they make up everything!", "I'm not good at jokes, but here's one: Why was the math book sad? Because it had too many problems."],
    "who created you": ["I was created by a team of developers.", "My creators prefer to remain anonymous."],
    "what is the weather today": ["I'm sorry, I can't provide real-time information.", "You can check the weather on a weather website or app."],
    "how old are you": ["I don't have an age. I'm just a program!", "I exist in the realm of ones and zeros, so I don't age."],
    "what is the meaning of life": ["The meaning of life is a philosophical question that has puzzled humans for centuries.", "I think the meaning of life is subjective and varies from person to person."]
}
